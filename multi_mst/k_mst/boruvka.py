...
@numba.njit()
def _merge_components(results, disjoint_set, component_edges, num_neighbors, epsilon):
    """
...
@numba.njit(parallel=True)
def _boruvka_tree_query(tree, node_components, point_components, core_distances, k):
    """
